 ...
 **********************************************************************************************************************/
@Getter @ToString
public class GracenoteException extends RuntimeException // FIXME: runtime or checked?
  {
    ...
    public GracenoteException (final @Nonnull String message)
      {
        super(message);
    ...
    public GracenoteException (final @Nonnull String message, final @Nonnull String responseStatus)
      {
        super(message);
    ...
    public GracenoteException (final @Nonnull String message, final @Nonnull HttpStatus httpStatus)
      {
        super(message);
    ...
    public GracenoteException (final @Nonnull Throwable cause)
      {
        super(cause);
        responseStatus = Optional.empty();
        httpStatus = Optional.empty();
