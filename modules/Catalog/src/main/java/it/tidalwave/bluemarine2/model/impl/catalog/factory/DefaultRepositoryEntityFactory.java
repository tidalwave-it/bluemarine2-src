    ...
    private void initialize()
      {
        ...
        factoryMapByType.put(RepositoryRecord.class, RepositoryRecord::new);
        factoryMapByType.put(RepositoryMusicArtist.class, RepositoryMusicArtist::new);
        factoryMapByType.put(RepositoryTrack.class, RepositoryTrack::new);
      }
  }
